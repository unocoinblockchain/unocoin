...
This means one can have an always-on unocoind instance running, and another local unocoind/unocoin-qt instance which connects to this node and receives blocks from it.
